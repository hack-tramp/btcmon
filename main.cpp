...
static string str_price = "loading";
static string url_btc = "api.cryptowat.ch/markets/coinbase-pro/btcusd/price";
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message)                  /* handle the messages */
    {
        ...
        case WM_TIMER:
            ...
            {
                case 1:
                    auto r = cpr::Get(cpr::Url{url_btc});
                    json jj = json::parse(r.text);
                    float price = jj["result"]["price"];
